...
const Bio: FC = () => {
    return(
        <div className='bio section' id='bio'>        
            ...
            I am a Frontend Developer Intern and former violinist from Northern California. 
            ...
            I have studied with Grigory Kalinovsky at the Jacobs’ School of Music and am studying under Julia Bushkova at UNT.
             ...
             <br></br><br></br>
            I also have experience working on a variety of different sound design projects in ProTools. 
