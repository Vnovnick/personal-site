...
const Portfolio: FC = () => {
    return (
        <div className="portfolio section block lg:grid" id="port">
            ...
            <div className="port-1-desc block lg:col-start-2">
                <div className="port-1-head">
                    <h3>Run Tracker</h3>
                    <a href="https://vnovnick.github.io/run-tracker-ns/" target='_blank' rel="noreferrer">
                        <img className='chain-link' src={chainLink} alt='link' width='17px' height='17px'></img>
                    </a>
                </div>                
                <div className="details">
                    <p>This project was born out of my own curiosity to see my Spotify song activity during my runs. 
                    ...
                    <p>(See <a href="https://github.com/Vnovnick/run-tracker-ns" target='_blank' rel="noreferrer">link</a> for Github Repo)</p>
                </div>
            </div>
        </div>
    );
